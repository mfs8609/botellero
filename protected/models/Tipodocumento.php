...
class Tipodocumento extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tipoDocumento', 'required'),
			array('tipoDocumento', 'length', 'max'=>50),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idTipoDocumento, tipoDocumento', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'vendedors' => array(self::HAS_MANY, 'Vendedor', 'idTipoDocumento'),
		);
	}
	...
	{
		return array(
			'idTipoDocumento' => 'Id Tipo de Documento',
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
			'criteria'=>$criteria,
			'sort'=>array(
				'defaultOrder'=>'tipoDocumento ASC',
				)
		));
	}
